...
namespace IntervalToast.Presentation.Windows
{
    ...
    public partial class NotificationWindow : Window, INotificationWindow
    {
        ...
        #region INotificationWindow Implementation

        /// <summary>
        /// Shows the notification (explicit interface implementation)
        /// </summary>
        void INotificationWindow.ShowNotification()
        {
            Show();
        }

        /// <summary>
        /// Closes the notification (explicit interface implementation)
        /// </summary>
        void INotificationWindow.CloseNotification()
        {
            CloseNotification();
        }
