...
namespace IntervalToast.Infrastructure.Persistence
{
    ...
    public class SettingsManager
    {
        ...
        private LegacyApplicationSettings _currentSettings;
        ...
        public SettingsManager()
        {
            ...
            _currentSettings = LegacyApplicationSettings.CreateDefault();
        ...
        /// </summary>
        public LegacyApplicationSettings CurrentSettings
        {
            get
            {
                lock (_settingsLock)
        ...
        public async Task<bool> LoadSettingsAsync()
        {
            try
            {
                ...
                var loadedSettings = JsonSerializer.Deserialize<LegacyApplicationSettings>(jsonContent, _jsonOptions);
        ...
        public async Task<bool> SaveSettingsAsync()
        {
            try
            {
                LegacyApplicationSettings settingsToSave;
                lock (_settingsLock)
                {
                    ValidateAndFixSettings();
        ...
        public async Task<bool> ExportSettingsAsync(string filePath)
        {
            try
            {
                LegacyApplicationSettings settingsToExport;
                lock (_settingsLock)
                {
        ...
        public async Task<bool> ImportSettingsAsync(string filePath)
        {
            try
            {
                ...
                var importedSettings = JsonSerializer.Deserialize<LegacyApplicationSettings>(jsonContent, _jsonOptions);
        ...
        public async Task<bool> ResetToDefaultsAsync()
        {
            try
            {
                LegacyApplicationSettings oldSettings;
                lock (_settingsLock)
                {
    ...
    /// <summary>
    /// Complete application settings container (legacy)
    /// </summary>
    public class LegacyApplicationSettings
    {
        /// <summary>
        ...
        /// </summary>
        public static LegacyApplicationSettings CreateDefault() => new LegacyApplicationSettings();

        /// <summary>
        /// Creates a deep copy of the settings
        /// </summary>
        public LegacyApplicationSettings Clone()
        {
            return new LegacyApplicationSettings
            {
                Version = Version,
    ...
    {
        public LegacyApplicationSettings Settings { get; }

        public SettingsEventArgs(LegacyApplicationSettings settings)
        {
