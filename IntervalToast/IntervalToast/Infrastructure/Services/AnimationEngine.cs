...
namespace IntervalToast.Infrastructure.Services
{
    ...
    public static class AnimationEngine
    {
        ...
        internal static void AnimateEntry(NotificationWindow window, NotificationConfiguration config, EventHandler? onCompleted = null)
        {
            try
            {
                if (window == null)
        ...
        /// <param name="config">The animation configuration</param>
        /// <param name="onCompleted">Optional callback when animation completes</param>
        internal static void AnimateExit(NotificationWindow window, NotificationConfiguration config, EventHandler? onCompleted = null)
        {
            try
            {
                if (window == null)
        ...
        internal static void AnimateHover(NotificationWindow window, NotificationConfiguration config, bool isEntering)
        {
            try
            {
        ...
        /// <param name="config">The animation configuration</param>
        /// <param name="onCompleted">Optional callback when animation completes</param>
        internal static void AnimateReposition(NotificationWindow window, System.Windows.Point targetPosition, NotificationConfiguration config, EventHandler? onCompleted = null)
        {
            try
            {
